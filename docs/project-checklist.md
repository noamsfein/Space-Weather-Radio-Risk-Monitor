...
- [~] **P0-2 · Create implementation directories** · Initials: `NF` · PR: `pending`
  - Prerequisites: P0-1.
...
- [ ] **P0-4 · Add local Kafka Compose configuration** · Initials: `____` · PR: `____`
  - Prerequisites: P0-1.
...
- [ ] **PROCESS-1 · Implement deduplication and rolling window** · Initials: `____` · PR: `____`
