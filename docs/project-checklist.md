...
- [x] **INGEST-2 · Implement live NOAA poller — optional until base path is green** · Initials: `NF` · PR: `#37`
...
- [x] **AI-5 · Complete `AI_USAGE.md` from actual work** · Initials: `NN` · PR: `#38`
  - Prerequisites: AI-4.
