...
- Claim a task by putting the branch name beside it or announcing it to the team.
...
- target `main`; and
- check the task off only after the PR is reviewed, merged, and manually verified.
...
- [x] **P0-0 · Establish a safe project Git root**
  - Prerequisites: none.
...
- [ ] **P0-1 · Confirm the contract and claim the first tasks**
  - Prerequisites: P0-0.
...
- [ ] **P0-2 · Create implementation directories**
  - Prerequisites: P0-1.
...
- [ ] **P0-4 · Add local Kafka Compose configuration**
  - Prerequisites: P0-1.
...
- [x] **DATA-0 · Verify the source is correct, current, and viable**
...
- [x] **DATA-1 · Capture and attribute a raw NOAA sample**
...
- [x] **DATA-2 · Create labeled deterministic fixtures**
...
- [ ] **CONTRACT-1 · Implement the canonical Pydantic event**
  - Prerequisites: DATA-1.
...
- [ ] **CONTRACT-2 · Freeze a representative event**
...
- [ ] **KAFKA-1 · Pass a broker smoke test**
...
- [ ] **INGEST-1 · Implement replay producer**
...
- [ ] **INGEST-2 · Implement live NOAA poller — optional until base path is green**
...
- [ ] **PROCESS-1 · Implement deduplication and rolling window**
...
- [ ] **PROCESS-2 · Implement crossing state**
...
- [ ] **PROCESS-3 · Connect Kafka consumer to processor and files**
...
- [ ] **AI-1 · Define briefing facts and deterministic fallback**
...
- [ ] **AI-3 · Implement automatic briefing checks**
  - Prerequisites: AI-1.
...
- [ ] **AI-5 · Complete `AI_USAGE.md` from actual work**
  - Prerequisites: AI-4.
...
- [ ] **TEST-1 · Complete contract and source tests**
  - Prerequisites: CONTRACT-1.
...
- [ ] **TEST-2 · Complete window and alert tests**
  - Prerequisites: PROCESS-2.
...
- [ ] **TEST-3 · Complete output and AI tests**
...
- [ ] **E2E-1 · Required end-to-end replay acceptance**
...
- [ ] **E2E-2 · Offline/no-key acceptance**
  - Prerequisites: E2E-1.
...
- [ ] **E2E-3 · Failure recovery demonstration — optional bonus only**
...
- [ ] **DOC-1 · Make README commands factual**
  - Prerequisites: E2E-1.
...
- [ ] **DOC-2 · Finalize source documentation**
...
- [ ] **DOC-3 · Draw final architecture chart**
  - Prerequisites: E2E-1.
...
- [ ] **REPORT-1 · Draft problem and result section**
  - Prerequisites: E2E-1.
...
- [ ] **REPORT-2 · Draft data and contract section**
...
- [ ] **REPORT-3 · Draft architecture and implementation section**
  - Prerequisites: DOC-3.
...
- [ ] **REPORT-4 · Draft evidence and reproducibility section**
...
- [ ] **REPORT-5 · Assemble and verify `report.pdf`**
...
- [ ] **PRES-1 · Build a short evidence-first deck**
...
- [ ] **PRES-2 · Prepare stable demo evidence**
  - Prerequisites: E2E-1.
...
- [ ] **PRES-4 · Rehearse and prepare Q&A**
...
- [ ] **PKG-1 · Confirm required package contents**
...
- [ ] **PKG-2 · Scan for prohibited or unrelated files**
  - Prerequisites: PKG-1.
...
- [ ] **PKG-3 · Create the exact archive**
  - Prerequisites: PKG-2.
...
- [ ] **PKG-4 · Clean-room TA test from extracted ZIP**
  - Prerequisites: PKG-3.
...
- [ ] **SUBMIT-1 · Final joint approval and upload**
  - Prerequisites: PKG-4.
